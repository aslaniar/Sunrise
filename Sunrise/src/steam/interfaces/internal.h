...
int get_friend_count(void*, int) noexcept;
std::uint64_t get_friend_by_index(void*, int, int) noexcept;
int get_friend_persona_state(void*, std::uint64_t) noexcept;
const char* get_friend_persona_name(void*, std::uint64_t) noexcept;
bool request_user_information(void*, std::uint64_t, bool) noexcept;
bool request_friend_rich_presence(void*, std::uint64_t) noexcept;
